package com.example.day5cw3.Aswathmodel;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class AswathLanguage {
    @Id
    private int languageId;
    private String languageName;
    private String languageComplexity;
    public AswathLanguage() {
    }
    public AswathLanguage(int languageId, String languageName, String languageComplexity) {
