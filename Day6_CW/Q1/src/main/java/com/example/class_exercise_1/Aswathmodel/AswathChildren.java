package com.example.class_exercise_1.Aswathmodel;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class AswathChildren {
     @Id
     private int babyId;
     ...
     public AswathChildren() {

     }

     public AswathChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
